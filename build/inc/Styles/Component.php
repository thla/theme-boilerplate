...
namespace WpMunich\ekihh\Styles;

use WpMunich\ekihh\Component_Interface;
use WpMunich\ekihh\Templating_Component_Interface;
...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	protected function get_css_files() : array {
		 ...
		 */
		$css_files = apply_filters( 'ekihh_css_files', $css_files );
	 ...
	 * {@see 'ekihh_preloading_styles_enabled'} filter can be used to tweak the return value.
	 *
	...
	protected function preloading_styles_enabled() {
		 ...
		 */
		return apply_filters( 'ekihh_preloading_styles_enabled', $preloading_styles_enabled );
	}
		...
		$handles = array_filter(
			...
			function( $handle ) use ( $css_files ) {
				...
				if ( ! $is_valid ) {
					...
					_doing_it_wrong( __CLASS__ . '::print_styles()', esc_html( sprintf( __( 'Invalid theme stylesheet handle: %s', 'ekihh' ), $handle ) ), 'ekihh' );
				}
