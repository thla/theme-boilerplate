...
class Component implements Component_Interface {
	...
	public function initialize() {
		if ( wp_get_environment_type() === 'development' && defined( 'LH_CURRENTLY_EDITING' ) && LH_CURRENTLY_EDITING === 'ekihh' ) {
	...
	public function add_options_page() {
		...
		$option_page = acf_add_options_page(
			array(
				'page_title' => __( 'Theme Settings', 'ekihh' ),
				'menu_title' => __( 'Theme Settings', 'ekihh' ),
				'menu_slug'  => 'ekihh-plugin-general-settings',
